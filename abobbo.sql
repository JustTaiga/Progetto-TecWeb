...
--
-- Host: localhost
-- Creato il: Dic 20, 2017 alle 10:46
...
--
ALTER TABLE `artisti`
  MODIFY `codArtista` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT per la tabella `biglietti`
--
ALTER TABLE `biglietti`
  MODIFY `codBig` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `articoli`
  ADD CONSTRAINT `articoli_ibfk_1` FOREIGN KEY (`emailAmm`) REFERENCES `amministratori` (`email`);

--
-- Limiti per la tabella `commenti`
--
ALTER TABLE `commenti`
  ADD CONSTRAINT `commenti_ibfk_1` FOREIGN KEY (`emailUt`) REFERENCES `utenti` (`email`),
  ADD CONSTRAINT `commenti_ibfk_2` FOREIGN KEY (`articolo`) REFERENCES `articoli` (`codArt`);
